const char FRIDGE_page_de[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<head>
...
<body style="font-family: verdana,sans-serif" BGCOLOR="#819FF7">
  <table>
    <tr><td style="text-align:right;">Temperatur:</td><td style="color:white;width:150px;"> <span id='temp'></span> °C</td><tr>
    <tr><td style="text-align:right;">Mittelwert:</td><td style="color:white;width:150px;"> <span id='avg'></span> °C</td><tr>
    <tr><td style="text-align:right;">Soll:</td><td style="color:white;width:150px;"> <span id='level'></span> °C</td><tr>
    <tr><td style="text-align:right;">Dutycycle:</td><td style="color:white;width:150px;"> <span id='dutycycle'></span></td><tr>
  ...
  <input type="button" class="button" value=" An " onclick="button_clicked('f_on')">
  <input type="button" class="button" value=" Aus " onclick="button_clicked('f_off')"> 
  </p>
  <p>
...
const char Settings_page_de[] PROGMEM = R"=====(
<!DOCTYPE html>
<html>
<head>
...
<body style="font-family: verdana,sans-serif" BGCOLOR="#819FF7">
  ...
  <table>
    <tr><td style="text-align:right;">Sprache:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="language"> 0=EN 1=DE</td></tr>
    <tr><td style="text-align:right;">Hysterese:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="hyst"> 1-5</td></tr>
    <tr><td style="text-align:right;">Drehzahl:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="rpm"> 0,>=2000<=3500</td></tr>
    <tr><td style="text-align:right;">Mittelw. Fehler:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="avgerror"> 0-2</td></tr>
    <tr><td style="text-align:right;">Max Hoch:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="maxhigh"> 5-12</td></tr>
    <tr><td style="text-align:right;">Max Niedrig:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="maxlow"> 0-5</td></tr>
    ...
    <tr><td style="text-align:right;">Boost Zeit:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="boosttime"> 10-120</td></tr>
    <tr><td style="text-align:right;">Boost Drehzahl:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="boostrpm"> >=2000<=3500</td></tr> 
    <tr><td style="text-align:right;">Max Laufzeit:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="maxruntime"> 10-60</td></tr> 
    <tr><td style="text-align:right;">Defrost Zeit:</td><td style="color:white;"><input type="text" style="width:50px; font-size: 18px;" id="defrosttime"> 10-60</td></tr> 
  </table>
   
  <hr>
  <p>
  <input type="button" class="button" value="Zurück" onclick="window.location.replace('/')"> 
